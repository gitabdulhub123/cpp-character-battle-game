...
void Item::print() {
    cout << "I am the virtual Item::print and I'm not used.\n";
}
void Weapon::print() {
...
void Potion::print() {
    cout << "\n " << name << "\n Level: " << experience_level << " " << type << endl;
    if (attribute_improvement == "Health")
        cout << " Restores: " << attribute_improvement << "\n by: " << increment << "%";
    else
        cout << " Increases: " << attribute_improvement << "\n Increment: " << increment << "X times";
    cout << "\n Cost: " << price << "$\n ";
...
void Spell::print() {
    ...
    else if (type == "Fire Spell")
        cout << "\n Reduces opponent's Defence \n for a few rounds";
    else if (type == "Lightning Spell")
